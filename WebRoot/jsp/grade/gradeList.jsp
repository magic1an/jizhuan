			...
			<ul class="nav nav-tabs">	
				<li class="dropdown pull-right">
					...
					<ul class="dropdown-menu">
						...
						<li>
							<a href="Grade_list.action?term=2">第二学期</a>
						</li>
						<li>
							<a href="Grade_list.action?term=3">第三学期</a>
						</li>
						<li>
							<a href="Grade_list.action?term=4">第四学期</a>
						</li>
						<li>
							<a href="Grade_list.action?term=4">第五学期</a>
						</li>
						<li>
							<a href="Grade_list.action?term=4">第六学期</a>
						</li>
					</ul>
				</li>
