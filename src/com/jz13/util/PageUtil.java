...
public class PageUtil {
	...
	public static String genPagination(String targetUrl,long totalNum,int currentPage,int pageSize,String param){
		...
		if(totalPage==0){
			...
			if (currentPage==1) {
				pageCode.append("<ul><li class=disabled><a>首页</a></li>");
			} else {
				pageCode.append("<ul><li><a href='"+targetUrl+"?page=1&"+param+"'>首页</a></li>");
			}
			if(currentPage==1){
			...
			if (currentPage==totalPage) {
				pageCode.append("<li class=disabled><a>尾页</a></li></ul>");
			} else {
				pageCode.append("<li><a href='"+targetUrl+"?page="+totalPage+"&"+param+"'>尾页</a></li></ul>");
			}
	...
	public static String genPaginationNoParam(String targetUrl,long totalNum,int currentPage,int pageSize){
		...
		if(totalPage==0){
			...
			pageCode.append("<li><a href='"+targetUrl+"?page="+totalPage+"'>尾页</a></li></ul>");
			return pageCode.toString();
		}
	}
}
